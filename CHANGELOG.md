...
## [1.20.0](https://github.com/aayushprsingh/arnio/compare/v1.19.0...v1.20.0) (2026-05-31)


### Features

* accept tuple subsets in round_numeric_columns ([#2031](https://github.com/aayushprsingh/arnio/issues/2031)) ([39b96a9](https://github.com/aayushprsingh/arnio/commit/39b96a907dc5bced2fccef8359b1d4598dd6b11a))
* add IQR outlier summary to column profiles ([#1003](https://github.com/aayushprsingh/arnio/issues/1003)) ([80c5ead](https://github.com/aayushprsingh/arnio/commit/80c5ead242d2a319a25e7f4bdb2aaa950b21aa95))
* add orient support to ArFrame.to_dict ([#2108](https://github.com/aayushprsingh/arnio/issues/2108)) ([7b9e6fe](https://github.com/aayushprsingh/arnio/commit/7b9e6fe7bcff02ea344a4cb712c964ac951e847e))
* add scan_csv permissive mode parity ([#1998](https://github.com/aayushprsingh/arnio/issues/1998)) ([2f8bcbe](https://github.com/aayushprsingh/arnio/commit/2f8bcbecdbd776eb55fb8380fac81d4f5765cd9f))
* add slugify_column_names cleaning primitive and pipeline step ([#1718](https://github.com/aayushprsingh/arnio/issues/1718)) ([0f1490d](https://github.com/aayushprsingh/arnio/commit/0f1490dcb9c3f2c52ce28e5ab433cee8d21e5719))
* export CleaningSuggestion from the top-level API (fixes [#1963](https://github.com/aayushprsingh/arnio/issues/1963)) ([#2024](https://github.com/aayushprsingh/arnio/issues/2024)) ([c017875](https://github.com/aayushprsingh/arnio/commit/c0178757cd2c0fa52f58ddbbd4945d9344b78099))
* implement fail-fast boundary validation in register_step ([#721](https://github.com/aayushprsingh/arnio/issues/721)) ([#1485](https://github.com/aayushprsingh/arnio/issues/1485)) ([cd52508](https://github.com/aayushprsingh/arnio/commit/cd52508011d38c921b4a6e80627cd9d5953bd254))
* improve footer ui and social links ([#1450](https://github.com/aayushprsingh/arnio/issues/1450)) ([fbb42c4](https://github.com/aayushprsingh/arnio/commit/fbb42c40eff209a3cb0d4fc584fd8806f0585dc8))
* include bool columns in describe ([#2012](https://github.com/aayushprsingh/arnio/issues/2012)) ([2f9119b](https://github.com/aayushprsingh/arnio/commit/2f9119b2ea56bfe2bad1d9ab98f87a7328698d27))
* **integrations:** expose ArnioCleaner lazily ([#2053](https://github.com/aayushprsingh/arnio/issues/2053)) ([7eb7a88](https://github.com/aayushprsingh/arnio/commit/7eb7a88cf3a790337a4c27d4d26db7c5f67c5b5d))
* **jsonl:** support encoding error handling ([#2040](https://github.com/aayushprsingh/arnio/issues/2040)) ([8651420](https://github.com/aayushprsingh/arnio/commit/86514201597cb9bfb2d4f75d921297d9e93083f6))
* optimize drop_duplicates hashing ([89a895a](https://github.com/aayushprsingh/arnio/commit/89a895a82faf245d6df4385e0f550042f1f49fd7))
* **sklearn:** enforce schema-stability contract in ArnioCleaner ([#946](https://github.com/aayushprsingh/arnio/issues/946)) ([#1036](https://github.com/aayushprsingh/arnio/issues/1036)) ([fc27829](https://github.com/aayushprsingh/arnio/commit/fc278291b2eb87aa39dfc1d71003c0a1722e5ef3))
* support file-like inputs in scan_csv ([#2238](https://github.com/aayushprsingh/arnio/issues/2238)) ([e01c564](https://github.com/aayushprsingh/arnio/commit/e01c56483dfdf5dd6e5651bdea52f16f1087a070))


### Bug Fixes

* **a11y:** respect reduced motion preference for anchor scrolling ([#2179](https://github.com/aayushprsingh/arnio/issues/2179)) ([2d09073](https://github.com/aayushprsingh/arnio/commit/2d090737402e25380fba41dd8769a0c682d66bbb)), closes [#2172](https://github.com/aayushprsingh/arnio/issues/2172)
* add __post_init__ validation to CleanStepRecord and CleanExplanation ([#1987](https://github.com/aayushprsingh/arnio/issues/1987)) ([a636f9c](https://github.com/aayushprsingh/arnio/commit/a636f9c992afcf0f41ec1de45013f95ed7033fb3))
* add CLI help guards to older benchmark scripts ([#2025](https://github.com/aayushprsingh/arnio/issues/2025)) ([3099fc5](https://github.com/aayushprsingh/arnio/commit/3099fc5f4d9cf51a80480dad13d1965861193500))
* add context to custom validator errors ([609120c](https://github.com/aayushprsingh/arnio/commit/609120cd978794fd26c7c68ebe98c8cf30705b1d))
* add context to custom validator errors ([7c60ec6](https://github.com/aayushprsingh/arnio/commit/7c60ec6efed03cfa1816629945fc37bc6976ef06))
* add deterministic report representation for notebooks and terminals ([#972](https://github.com/aayushprsingh/arnio/issues/972)) ([6182ac1](https://github.com/aayushprsingh/arnio/commit/6182ac17a1b01fdbfbfbbef8a03f78131098a7cb))
* add Escape key support and sync aria-label for mobile menu ([#2100](https://github.com/aayushprsingh/arnio/issues/2100)) ([c7ee2fb](https://github.com/aayushprsingh/arnio/commit/c7ee2fb597835a8f6604f1e30e91147be343a9c7))
* align issue template labels with live taxonomy (Fixes [#1372](https://github.com/aayushprsingh/arnio/issues/1372)) ([#2187](https://github.com/aayushprsingh/arnio/issues/2187)) ([55a708c](https://github.com/aayushprsingh/arnio/commit/55a708c120d0bda690c80d2f82976f8fdae7700c))
* allow tuple input in ArFrame.drop_columns ([#2011](https://github.com/aayushprsingh/arnio/issues/2011)) ([68ae15f](https://github.com/aayushprsingh/arnio/commit/68ae15f4449a1cf300b76e1b147c8637e1c9f842))
* allow unregistering custom aliases of built-in cleaning steps ([#2008](https://github.com/aayushprsingh/arnio/issues/2008)) ([3a303f1](https://github.com/aayushprsingh/arnio/commit/3a303f14e0a59eaad7fb02b4f9ebd64c75abb4ea))
* avoid returning original frame from drop_empty_columns zero-row path ([#1996](https://github.com/aayushprsingh/arnio/issues/1996)) ([78fdccc](https://github.com/aayushprsingh/arnio/commit/78fdccc5d274a256f5c0e93c020b7b66043c3fe8))
* clarify HTML repr for non-empty zero-column frames ([#2124](https://github.com/aayushprsingh/arnio/issues/2124)) ([2750075](https://github.com/aayushprsingh/arnio/commit/2750075d6518056a0a05a7050341611c353d2400))
* **cleaning:** return new frame from winsorize no-op path ([d98c8fd](https://github.com/aayushprsingh/arnio/commit/d98c8fd2a0238029031066028c255c608cfd51e5))
* **cleaning:** validate safe_divide_columns column name types ([#2107](https://github.com/aayushprsingh/arnio/issues/2107)) ([3f8b640](https://github.com/aayushprsingh/arnio/commit/3f8b6407a2ab0a2945c088e9b8c0b298499882a6))
* clone clean column names noop ([#2029](https://github.com/aayushprsingh/arnio/issues/2029)) ([444cb80](https://github.com/aayushprsingh/arnio/commit/444cb801d6ada21c0e3add4cadb5ee17126dff81))
* **convert:** validate scalar values in from_dict ([#2151](https://github.com/aayushprsingh/arnio/issues/2151)) ([af8878a](https://github.com/aayushprsingh/arnio/commit/af8878a33455c3827dd02a52037f2efc4041fb98)), closes [#1653](https://github.com/aayushprsingh/arnio/issues/1653)
* **csv:** preserve mid-field quotes ([#1993](https://github.com/aayushprsingh/arnio/issues/1993)) ([2810f7a](https://github.com/aayushprsingh/arnio/commit/2810f7aff05925c396fe63012685c84f988da747))
* **csv:** use shared delimiter validation in write_csv ([#2121](https://github.com/aayushprsingh/arnio/issues/2121)) ([8642d9d](https://github.com/aayushprsingh/arnio/commit/8642d9d2b5094df39ceba53768db8eb2c5e91581))
* DataQualityReport.to_pandas ([#2148](https://github.com/aayushprsingh/arnio/issues/2148)) ([4706777](https://github.com/aayushprsingh/arnio/commit/47067773bb79387856f8a29b94b86052ef1cf807))
* deduplicate strict auto_clean after normalization ([2c1fb60](https://github.com/aayushprsingh/arnio/commit/2c1fb6030eecbd7b650dbd11ce2eab51b5868794))
* deduplicate strict auto_clean after normalization ([c947eb4](https://github.com/aayushprsingh/arnio/commit/c947eb4727160ed7c69eaf08688c5a6783e33a21))
* defer ArnioCleaner param validation to fit/transform ([#1959](https://github.com/aayushprsingh/arnio/issues/1959)) ([3bda610](https://github.com/aayushprsingh/arnio/commit/3bda610d64533e05c612972386dfd9171ffd7621))
* deterministic sort for mixed-type allowed values ([#2017](https://github.com/aayushprsingh/arnio/issues/2017)) ([121f121](https://github.com/aayushprsingh/arnio/commit/121f1216eec95f58ca4e9a6e12ba23211deb53b6))
* forced bool dtype raises CsvReadError for invalid non-null tokens ([#2001](https://github.com/aayushprsingh/arnio/issues/2001)) ([e6002ea](https://github.com/aayushprsingh/arnio/commit/e6002ea98516ea9f8b05e7f1b723da1064b1108a))
* **frame:** handle non-finite float values in describe ([#2002](https://github.com/aayushprsingh/arnio/issues/2002)) ([7fe483c](https://github.com/aayushprsingh/arnio/commit/7fe483c875001a5b4f3e74e4cc3e6ccf2b30890a))
* **frame:** preserve attrs in head and tail ([#2055](https://github.com/aayushprsingh/arnio/issues/2055)) ([5dd47a0](https://github.com/aayushprsingh/arnio/commit/5dd47a07a420d138037d6d08205e0f33697f515b))
* guard unsafe float to int64 casts ([#2003](https://github.com/aayushprsingh/arnio/issues/2003)) ([8dfdd96](https://github.com/aayushprsingh/arnio/commit/8dfdd96d7f9b9e56fe2c1dc9afa34dfff6fae76d))
* handle non-json attrs in parquet export ([c1f014b](https://github.com/aayushprsingh/arnio/commit/c1f014b331d4ea4fc3fe5cdaed542bb80dceedde)), closes [#1907](https://github.com/aayushprsingh/arnio/issues/1907)
* handle zero-column frames in drop_columns_matching ([#2215](https://github.com/aayushprsingh/arnio/issues/2215)) ([0070340](https://github.com/aayushprsingh/arnio/commit/0070340ad3c5b2694b6ba291c63d9827f69bf488))
* honor case-insensitive semantic code validation ([c4a4cfb](https://github.com/aayushprsingh/arnio/commit/c4a4cfb4f6eafc350b22b5c9b8c3ddd55dcca9c8))
* include website text assets in UTF-8 validation ([#2110](https://github.com/aayushprsingh/arnio/issues/2110)) ([3368e59](https://github.com/aayushprsingh/arnio/commit/3368e593f3a9e716695a96eaf4399f51032578f5))
* **integrations:** reject whitespace-only DuckDB relation names ([#2116](https://github.com/aayushprsingh/arnio/issues/2116)) ([14733ae](https://github.com/aayushprsingh/arnio/commit/14733ae8701178919b6bc94883f0888bb6ed9499))
* **io:** validate parquet compression argument type ([f6249bc](https://github.com/aayushprsingh/arnio/commit/f6249bc6c2bad18128182adea32ae6d1830bb0e5))
* make code block copy buttons visible on keyboard focus ([#1992](https://github.com/aayushprsingh/arnio/issues/1992)) ([16251f7](https://github.com/aayushprsingh/arnio/commit/16251f79ae09486b5991bfd569333f53204afb29))
* make custom pipeline step frames writable ([70134f0](https://github.com/aayushprsingh/arnio/commit/70134f0849da992b248733a19b61123c02e42972))
* optimize website logo assets ([#2220](https://github.com/aayushprsingh/arnio/issues/2220)) ([0fe9bf2](https://github.com/aayushprsingh/arnio/commit/0fe9bf221716c3e8f147d4ee3da8d5785c352b21))
* **pipeline:** protect Python-backed built-in steps ([adf372f](https://github.com/aayushprsingh/arnio/commit/adf372f3696a69546bad204923c33a2b31aefb79))
* preserve arrow rows for zero-column frames ([bae3fbd](https://github.com/aayushprsingh/arnio/commit/bae3fbd56fc145a36befa7f84eb0d7224666bc71))
* preserve attrs metadata in ArFrame selection methods ([#1999](https://github.com/aayushprsingh/arnio/issues/1999)) ([17aa4a5](https://github.com/aayushprsingh/arnio/commit/17aa4a552908845f3c7c3cda589f147efc1085c7))
* preserve chunked csv streaming validation ([5d7c2fb](https://github.com/aayushprsingh/arnio/commit/5d7c2fb8b4cf1e0c2d5bde493007b6d67e777d90))
* preserve chunked csv streaming validation ([c58654c](https://github.com/aayushprsingh/arnio/commit/c58654c4464139fe20e5229c614a582943d5e6b1))
* preserve Float64 nullable dtype in from_pandas round-trip ([#1984](https://github.com/aayushprsingh/arnio/issues/1984)) ([5e2aa95](https://github.com/aayushprsingh/arnio/commit/5e2aa95f958c546a0ee0598c884b122cbcd5c3a9))
* preserve row count in normalize_unicode for zero-column frames (… ([#2006](https://github.com/aayushprsingh/arnio/issues/2006)) ([6973603](https://github.com/aayushprsingh/arnio/commit/6973603d37b2308fc094dedbfe0f72033e758ebb))
* prevent benchmark scripts from deleting user files ([#2021](https://github.com/aayushprsingh/arnio/issues/2021)) ([38f19ff](https://github.com/aayushprsingh/arnio/commit/38f19ff774549d1cb263cee24e628449fc0f7cc6))
* prevent float64 suggestions for non-finite numeric strings ([10e5216](https://github.com/aayushprsingh/arnio/commit/10e5216bb2e5bd908cd0d51da74f933942650889))
* **quality:** validate quality gate result constructors ([#2041](https://github.com/aayushprsingh/arnio/issues/2041)) ([a8ecdc2](https://github.com/aayushprsingh/arnio/commit/a8ecdc23d3c27fe4a0c819c86dd6fd6901463597))
* reject duplicate subset columns ([78f001f](https://github.com/aayushprsingh/arnio/commit/78f001f8bd056640d8d106cf08ec69880402c78c))
* reject empty subset in fill_nullsfix: reject empty subset in fill_nulls ([#2103](https://github.com/aayushprsingh/arnio/issues/2103)) ([fd2f0fb](https://github.com/aayushprsingh/arnio/commit/fd2f0fb6b2cab7d8c4330b0b44b2777926546aa3))
* reject impossible numeric Field bounds ([58abccc](https://github.com/aayushprsingh/arnio/commit/58abcccd4deacab73165a028fed0ec7494f8c9a4))
* reject invalid tokens for forced numeric CSV dtypes ([#1980](https://github.com/aayushprsingh/arnio/issues/1980)) ([169e5a2](https://github.com/aayushprsingh/arnio/commit/169e5a2ef59bab018cfae2caf4129a8474499259))
* reject NaN/Infinity/-Infinity in read_jsonl with JsonlReadError line context ([#2150](https://github.com/aayushprsingh/arnio/issues/2150)) ([9c284b4](https://github.com/aayushprsingh/arnio/commit/9c284b4657a5fb2412a9f5cbe66f27f2e4f5f96b)), closes [#1943](https://github.com/aayushprsingh/arnio/issues/1943)
* reject non-finite bounds in Int64 and Float64 ([#2120](https://github.com/aayushprsingh/arnio/issues/2120)) ([1272625](https://github.com/aayushprsingh/arnio/commit/1272625809378f609e0aa5c6c9331347604609a9))
* reject unknown keys in schema json payloads ([#2106](https://github.com/aayushprsingh/arnio/issues/2106)) ([a7bae81](https://github.com/aayushprsingh/arnio/commit/a7bae817769539845496335dfa337e4a8a8e0426))
* reject unsupported object scalars in from_pandas ([#1903](https://github.com/aayushprsingh/arnio/issues/1903)) ([#1983](https://github.com/aayushprsingh/arnio/issues/1983)) ([e5d5e6c](https://github.com/aayushprsingh/arnio/commit/e5d5e6cc86547f76236b89d09ca785c93c9a8eaf))
* reject whitespace-only names in register_validator ([#2123](https://github.com/aayushprsingh/arnio/issues/2123)) ([159b6a4](https://github.com/aayushprsingh/arnio/commit/159b6a46166483695549ef86892a8fdfe3d295d6))
* reject zero-column Parquet export that drops row count ([#2007](https://github.com/aayushprsingh/arnio/issues/2007)) ([8c470ea](https://github.com/aayushprsingh/arnio/commit/8c470ea825af935486efce9ea8fd29126006c2e9))
* remove stale native extension artifacts in make clean ([#2109](https://github.com/aayushprsingh/arnio/issues/2109)) ([ac52735](https://github.com/aayushprsingh/arnio/commit/ac5273566d637d318c2172cc85b9928c65896df6))
* render zero-column ArFrame strings clearly ([2070b39](https://github.com/aayushprsingh/arnio/commit/2070b3925aca203c3699f8b666a5edb002fcfc91))
* require auto_clean cast confirmation ([#2093](https://github.com/aayushprsingh/arnio/issues/2093)) ([9cbc1a7](https://github.com/aayushprsingh/arnio/commit/9cbc1a77f4848123d9564cf1d7c172132c779bae))
* resolve __version__ from pyproject.toml in source checkouts ([#2217](https://github.com/aayushprsingh/arnio/issues/2217)) ([78547ca](https://github.com/aayushprsingh/arnio/commit/78547ca043f6e058e5dddd2b3d51b4e59b6ded8f))
* respect encoding in delimiter sniffing ([83310cb](https://github.com/aayushprsingh/arnio/commit/83310cb3b7ff490ec3b3ad8d60527e6dc7541e2c))
* restrict write_csv line_terminator to standard newline values ([#2004](https://github.com/aayushprsingh/arnio/issues/2004)) ([017d8d4](https://github.com/aayushprsingh/arnio/commit/017d8d4ae2a3c839580a1d82a862e637dea12375))
* return fresh object for zero-row drop_constant_columns ([#2026](https://github.com/aayushprsingh/arnio/issues/2026)) ([18ffc55](https://github.com/aayushprsingh/arnio/commit/18ffc55f5f80b22ca90874f32d6c3fe358c1beb1))
* return zero-column ArFrame when select_dtypes matches no columns ([#1978](https://github.com/aayushprsingh/arnio/issues/1978)) ([50d5bb3](https://github.com/aayushprsingh/arnio/commit/50d5bb32be63b49af551061610cd35655e08677b))
* **schema:** include schema rules in diff_schema ([c7fa645](https://github.com/aayushprsingh/arnio/commit/c7fa64590aa8eac15d09ee9c1e9db148156b7050))
* **schema:** normalize timestamps and arrays in validation exports ([d9fef17](https://github.com/aayushprsingh/arnio/commit/d9fef177dbba75d0828f724bb8ff8993fd1f03f9))
* **schema:** preserve severity for unknown semantic issues ([9b1ef0f](https://github.com/aayushprsingh/arnio/commit/9b1ef0f37baab5088f486b0d8d7a12549d1151c5))
* **schema:** reject bare strings in CurrencyCode allowed values ([ccd7b58](https://github.com/aayushprsingh/arnio/commit/ccd7b5807a9e8298e39ac84630fad6aeaab42dea))
* **schema:** require explicit custom validator overwrite ([#2046](https://github.com/aayushprsingh/arnio/issues/2046)) ([4dbdcc3](https://github.com/aayushprsingh/arnio/commit/4dbdcc35277662ccee2bb4604c461326c39a7e7a))
* **schema:** validate core ValidationIssue fields ([53571de](https://github.com/aayushprsingh/arnio/commit/53571deb3009aa7800a8c15c5ec1fc6aa6ff96dd))
* **schema:** validate ValidationResult constructor fields ([#2102](https://github.com/aayushprsingh/arnio/issues/2102)) ([5ca9786](https://github.com/aayushprsingh/arnio/commit/5ca978602b8a42f13a1e0d7b91d8bf81019961ae))
* skip empty chunked CSV frames after bad-row filtering ([#1991](https://github.com/aayushprsingh/arnio/issues/1991)) ([fb56f8b](https://github.com/aayushprsingh/arnio/commit/fb56f8b44e17aafa95893d3b3cd982b55099fd69))
* skip empty chunked CSV frames after bad-row filtering ([#1991](https://github.com/aayushprsingh/arnio/issues/1991)) ([#2016](https://github.com/aayushprsingh/arnio/issues/2016)) ([7a85e0b](https://github.com/aayushprsingh/arnio/commit/7a85e0be032afc9e42b24d88066d63271ff3a6bf))
* subprocess-validation-issue ([#2000](https://github.com/aayushprsingh/arnio/issues/2000)) ([82e5077](https://github.com/aayushprsingh/arnio/commit/82e507781089d40840924567c8b9a7af32d02a70))
* support cast_types ignore errors ([#2094](https://github.com/aayushprsingh/arnio/issues/2094)) ([1534ceb](https://github.com/aayushprsingh/arnio/commit/1534cebfcaddd74248bce939b06a4219dbfdcdb4))
* support non-ASCII write_csv output paths ([#2018](https://github.com/aayushprsingh/arnio/issues/2018)) ([9681512](https://github.com/aayushprsingh/arnio/commit/968151263121fff22b47e58e23697bdb7f13f087))
* **types:** add select_rows to Frame native stub ([#1683](https://github.com/aayushprsingh/arnio/issues/1683)) ([#1934](https://github.com/aayushprsingh/arnio/issues/1934)) ([f356865](https://github.com/aayushprsingh/arnio/commit/f35686589d156eec3910c2900b636b17d0414506))
* validate and normalize structured metadata in schema_to_dict ([#1797](https://github.com/aayushprsingh/arnio/issues/1797)) ([#2030](https://github.com/aayushprsingh/arnio/issues/2030)) ([eedfafa](https://github.com/aayushprsingh/arnio/commit/eedfafa96e260aa5f48921d5e209587d25cd4cc6))
* validate ArFrame astype dtype arguments ([24c7e20](https://github.com/aayushprsingh/arnio/commit/24c7e20bb632b4291d5491f7c461ed19cfc2e7b2))
* validate ArnioCleaner set_params updates ([f575a00](https://github.com/aayushprsingh/arnio/commit/f575a00239fe4698c02da8950cb45358ff5e2043))
* validate Custom validator names before registry lookup ([#2043](https://github.com/aayushprsingh/arnio/issues/2043)) ([305bccd](https://github.com/aayushprsingh/arnio/commit/305bccd2ed041992a38948af796a51420a3ed47c))
* validate empty HTML report output paths ([1e5fda0](https://github.com/aayushprsingh/arnio/commit/1e5fda051cad2d58a494290a3128e71e4fe70a9d))
* validate filter_rows column and op argument types ([7b13122](https://github.com/aayushprsingh/arnio/commit/7b13122dffb20c828d49345fe73071cedcad2978))
* validate frame inputs in CSV and Parquet writers ([#2037](https://github.com/aayushprsingh/arnio/issues/2037)) ([8a43300](https://github.com/aayushprsingh/arnio/commit/8a433004413a7b1fc3ed7f7f45cc1862ba4c02e1)), closes [#1408](https://github.com/aayushprsingh/arnio/issues/1408)
* validate parse_bool_strings token container types ([#2015](https://github.com/aayushprsingh/arnio/issues/2015)) ([cf33bbd](https://github.com/aayushprsingh/arnio/commit/cf33bbdae70d179d4c2c5b7dbdfd31ab7e4858ac))
* validate pipeline registry inputs before state mutation ([#1849](https://github.com/aayushprsingh/arnio/issues/1849)) ([4cbe53f](https://github.com/aayushprsingh/arnio/commit/4cbe53f3abeb27154c4a164edfe2fd3e3fa4e7fe))
* validate ProfileComparison status_counts values ([#2005](https://github.com/aayushprsingh/arnio/issues/2005)) ([caa4963](https://github.com/aayushprsingh/arnio/commit/caa4963bf7b7ffb4c69ec44148e5de004add4449))
* validate quality report dataclass invariants ([1d9ab8a](https://github.com/aayushprsingh/arnio/commit/1d9ab8a594c51fdcdb96a05a360fce1c54103bdd))
* validate required_if scalar values ([32a819a](https://github.com/aayushprsingh/arnio/commit/32a819a34179f3653b29b837f7d2c7fc27bd6941))
* validate safe_divide_columns fill_value ([#1850](https://github.com/aayushprsingh/arnio/issues/1850)) ([2f5f9bc](https://github.com/aayushprsingh/arnio/commit/2f5f9bcb46af994ee6ac6fadf91c1ac6215accc9))
* validate steps argument in ArnioCleaner.__init__ and fit ([#2101](https://github.com/aayushprsingh/arnio/issues/2101)) ([974a039](https://github.com/aayushprsingh/arnio/commit/974a039a0efa1ce949994943a692c81147d544b8))
* validate writer output path before suffix checks ([50feb05](https://github.com/aayushprsingh/arnio/commit/50feb05ef94fdf26181bbad2197329ba7df5afeb))
* **website:** fix code highlighter corrupting copied Python snippets ([b7ce226](https://github.com/aayushprsingh/arnio/commit/b7ce226ab18533613ff233a4d65336b2e0c99a7f))
* **website:** fix code highlighter corrupting copied Python snippets ([0820dcb](https://github.com/aayushprsingh/arnio/commit/0820dcb79af9fd8e3f8b547628e7e1b4909f22fa)), closes [#2154](https://github.com/aayushprsingh/arnio/issues/2154)
* **website:** handle unavailable localStorage in theme script ([#2237](https://github.com/aayushprsingh/arnio/issues/2237)) ([ce7b495](https://github.com/aayushprsingh/arnio/commit/ce7b495e7a0bb36c5fe2d61436424827f51640f4))


### Performance Improvements

* defer non-critical JS and lazy load footer images ([36aef98](https://github.com/aayushprsingh/arnio/commit/36aef98ab6ff22fb0e809257c4255b0343493604)), closes [#2054](https://github.com/aayushprsingh/arnio/issues/2054)
* skip csv inference for fully explicit dtypes ([#1910](https://github.com/aayushprsingh/arnio/issues/1910)) ([5d1f66b](https://github.com/aayushprsingh/arnio/commit/5d1f66b04314e0b94fb3311ffd02212202a0dba0))
* vectorize date semantic validation ([4136bb8](https://github.com/aayushprsingh/arnio/commit/4136bb85f9efcbd784ca9ebde708d6f8bea5ae6f))
* vectorize date semantic validation ([a37adae](https://github.com/aayushprsingh/arnio/commit/a37adaeb87f9c8e22c197014b1c6860bf6470d14))


### Documentation

* add cross-domain data drift and profile comparison tutorial ([#2147](https://github.com/aayushprsingh/arnio/issues/2147)) ([37365da](https://github.com/aayushprsingh/arnio/commit/37365da5f2b743f089593612e38f6ecab61710f5))
* add pandas accessor examples for suggest_cleaning, auto_clean, and validate ([#2183](https://github.com/aayushprsingh/arnio/issues/2183)) ([c0d6aac](https://github.com/aayushprsingh/arnio/commit/c0d6aaca072d958cb1d1db03bcbdb4185a221e0e))
* add read_csv parser options note to website API entry ([c3a3416](https://github.com/aayushprsingh/arnio/commit/c3a341658e5f641a1a0953ef5b3dc620841a01cc)), closes [#2155](https://github.com/aayushprsingh/arnio/issues/2155)
* add read_csv_chunked parity note and confirm full signature ([0ee92bd](https://github.com/aayushprsingh/arnio/commit/0ee92bdf470908212cc9f94da29961823adb7e79)), closes [#2156](https://github.com/aayushprsingh/arnio/issues/2156)
* add scan_csv sampling example ([#2216](https://github.com/aayushprsingh/arnio/issues/2216)) ([ab0bc56](https://github.com/aayushprsingh/arnio/commit/ab0bc56b22611719609cbc3f2d43467d367903c2))
* add schema unique and cross-field rule examples ([3b2870b](https://github.com/aayushprsingh/arnio/commit/3b2870b9ae1760121146f0690aea5bdbacf5da60)), closes [#2169](https://github.com/aayushprsingh/arnio/issues/2169)
* Added the post assignment and reassignment rules. ([#1997](https://github.com/aayushprsingh/arnio/issues/1997)) ([c373286](https://github.com/aayushprsingh/arnio/commit/c373286bc29b42a8c168ea08581cab817750c072))
* align website API reference exports ([940ba37](https://github.com/aayushprsingh/arnio/commit/940ba372551c65962730d84826a4ee71f376f8c1))
* aligned the labels with the live labels ([#1946](https://github.com/aayushprsingh/arnio/issues/1946)) ([ab91e50](https://github.com/aayushprsingh/arnio/commit/ab91e50c29929e78be3311d77ad787507a0edbd7))
* **api:** document auto_clean safety options and return shapes ([b62d1fb](https://github.com/aayushprsingh/arnio/commit/b62d1fbf3a4d9b94c4c0d499ed650caf8f202fe8))
* **api:** document auto_clean safety options and return shapes ([0da3869](https://github.com/aayushprsingh/arnio/commit/0da3869ff6bb10bdfdedcb70a593a5c0e1428661))
* **api:** document DataQualityReport exporter signatures and options ([#2212](https://github.com/aayushprsingh/arnio/issues/2212)) ([2138ef8](https://github.com/aayushprsingh/arnio/commit/2138ef80232bea8f9378917f730a0d8e554e3ed8))
* clarify duplicate header handling status ([42ea3e4](https://github.com/aayushprsingh/arnio/commit/42ea3e4274abbcf4bd628b290c31d09f7138673e))
* clarify sniff_delimiter sample_size is character-count, not byte-count ([#1958](https://github.com/aayushprsingh/arnio/issues/1958)) ([8660eed](https://github.com/aayushprsingh/arnio/commit/8660eed34ddaeb2834ba76383678b420b17ce218)), closes [#1944](https://github.com/aayushprsingh/arnio/issues/1944)
* document additional ArFrame helper methods ([b54e782](https://github.com/aayushprsingh/arnio/commit/b54e7826cb7020fc893c3ef2dcc1e33ec1635498))
* document additional ArFrame helper methods ([8ad20ca](https://github.com/aayushprsingh/arnio/commit/8ad20ca74e68b12a575c7bc581c91b831e39d5e9))
* document df.arnio.clean() in website API reference ([#2223](https://github.com/aayushprsingh/arnio/issues/2223)) ([c9f5829](https://github.com/aayushprsingh/arnio/commit/c9f58297104e1f623302c8cfe9d767e0b7d77219))
* document notebook HTML representations for ArFrame and DataQualityReport ([#2185](https://github.com/aayushprsingh/arnio/issues/2185)) ([23d2eb2](https://github.com/aayushprsingh/arnio/commit/23d2eb2b13f24a4e1496a0b3ea2ffd376126973e))
* document quality gate thresholds ([ffdaac4](https://github.com/aayushprsingh/arnio/commit/ffdaac49d198932e4faa6879346528246c3afab3))
* document quality gate thresholds ([473de95](https://github.com/aayushprsingh/arnio/commit/473de955b4fb62e53df495746cb5d08658e3b6ce))
* document Schema unique and rules options ([#2186](https://github.com/aayushprsingh/arnio/issues/2186)) ([09a8654](https://github.com/aayushprsingh/arnio/commit/09a8654139a5bba922ed947ceed18d24d4b57a84))
* document sniff_delimiter sample_size parameter ([#2206](https://github.com/aayushprsingh/arnio/issues/2206)) ([933902a](https://github.com/aayushprsingh/arnio/commit/933902a79ab6854aaff77fd83963166d50ef0fc3)), closes [#2160](https://github.com/aayushprsingh/arnio/issues/2160)
* document write_parquet preserve_attrs and compression options ([#2208](https://github.com/aayushprsingh/arnio/issues/2208)) ([d6574b6](https://github.com/aayushprsingh/arnio/commit/d6574b6ec803ab561c9fc34baa6c4755b8bf6f1a)), closes [#2159](https://github.com/aayushprsingh/arnio/issues/2159)
* **examples:** use clip_numeric in NumPy example ([#2045](https://github.com/aayushprsingh/arnio/issues/2045)) ([1640f5c](https://github.com/aayushprsingh/arnio/commit/1640f5cce19b67b68fc3c76ede4523c5fa521e61))
* expand field builder parameter details ([#2190](https://github.com/aayushprsingh/arnio/issues/2190)) ([fe4e21d](https://github.com/aayushprsingh/arnio/commit/fe4e21ddcc6d89e9a1341fb686e5232ea80a7397))
* fix label name mismatches in ISSUE_TRIAGE.md ([#2127](https://github.com/aayushprsingh/arnio/issues/2127)) ([5b79cf0](https://github.com/aayushprsingh/arnio/commit/5b79cf0f367b2d8372bd8b033439078afb07d69a))
* improve Quickstart onboarding guidance ([#741](https://github.com/aayushprsingh/arnio/issues/741)) ([970d833](https://github.com/aayushprsingh/arnio/commit/970d8333011a924a9f34b49146b86cb3797a28f4))
* refresh roadmap status text ([#1961](https://github.com/aayushprsingh/arnio/issues/1961)) ([63c9ba9](https://github.com/aayushprsingh/arnio/commit/63c9ba9933384efb6c8d917ef7b27b0d56ea03b0))
* remove corrupted separators from API reference ([#1829](https://github.com/aayushprsingh/arnio/issues/1829)) ([5233d5e](https://github.com/aayushprsingh/arnio/commit/5233d5e50dd1dc678d3fc35cd5dc24edd8b2b7e8))
* Update README with current active URL ([e2f47d2](https://github.com/aayushprsingh/arnio/commit/e2f47d271ea6eb2546aab828130e3e2ac5490e8f))
* update website latest release references to v1.19.0 ([addde49](https://github.com/aayushprsingh/arnio/commit/addde49f620427de1967329a20f88e165351994d)), closes [#2115](https://github.com/aayushprsingh/arnio/issues/2115)
* update website read_jsonl signature for encoding options ([#2218](https://github.com/aayushprsingh/arnio/issues/2218)) ([adc9b1b](https://github.com/aayushprsingh/arnio/commit/adc9b1bc477ff860f4b1f428eeb1a3832097b573))
* **website:** document CI checks for contributors ([#2222](https://github.com/aayushprsingh/arnio/issues/2222)) ([0a765fb](https://github.com/aayushprsingh/arnio/commit/0a765fb95e58973fd8e1438dd0b2d80dda836d35))
